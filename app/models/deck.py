...
class Deck(db.Model):
    ...
    owner_id = db.Column(db.Integer,  db.ForeignKey('dockerrender.users.id'), nullable=False)
    user_id = db.Column(db.Integer, db.ForeignKey('dockerrender.users.id'), nullable=False)
