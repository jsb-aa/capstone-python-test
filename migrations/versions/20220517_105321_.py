...
def upgrade():
    op.execute('CREATE SCHEMA IF NOT EXISTS helloflask')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['owner_id'], ['helloflask.users.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['helloflask.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='helloflask'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['deck_id'], ['helloflask.decks.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='helloflask'
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute('DROP SCHEMA helloflask CASCADE')
    # ### end Alembic commands ###
