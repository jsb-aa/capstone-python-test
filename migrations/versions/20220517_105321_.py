...
def upgrade():
    op.execute('CREATE SCHEMA IF NOT EXISTS dockerrender')
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['owner_id'], ['dockerrender.users.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['dockerrender.users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='dockerrender'
    )
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['deck_id'], ['dockerrender.decks.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='dockerrender'
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.execute('DROP SCHEMA dockerrender CASCADE')
    # ### end Alembic commands ###
